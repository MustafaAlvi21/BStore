            ...
            $('.scrolling  a[href*="#"]').on("click", function(e) {
                ...
                $(".body-wrapper").each(function() {
                    var e = $(".header"),
                        o = e.children(".navbar"),
                        s =
                            (o.find(".navbar-header"),
                            o.find(".navbar-collapse")),
                        a = { nav_top: s.css("margin-top") };
        ...
        $("#price-range").slider({
            ...
            (function(e) {
                ...
                e("#carousel").on("slide.bs.carousel", function(s) {
                    ...
                    t > i
                        ? (e("#thumbcarousel").one("slid.bs.carousel", function(
                              o
                          ) {
